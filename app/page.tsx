        ...
        <header id="home" className="flex flex-col-reverse md:flex-row w-full h-screen max-w-7xl items-center justify-center p-8 relative overflow-x-hidden">
          <div className='w-full h-2/4 md:h-full md:w-2/5 flex flex-col justify-center items-center md:items-start gap-8'>
            <div className='flex flex-col gap-2'>
              ...
              <h2 className='text-md md:text-2xl'>Insightful é uma ferramenta de otimização de vendas alimentada por inteligência artificial que fornece insights baseados em dados para impulsionar o desempenho de vendas.</h2>
            </div>
            <p className='max-w-md text-sm md:text-base text-zinc-500'>Insightful é uma ferramenta de otimização de vendas baseada em IA que fornece insights baseados em dados para aumentar o desempenho de vendas.
</p>
            <div className='w-full flex items-center justify-center md:justify-start gap-4'>
              ...
              <button className='w-48 h-12 text-sm sm:text-base rounded bg-white text-black hover:bg-fuchsia-700 hover:text-white transition-colors'>Contato</button>
            </div>
          </div>
